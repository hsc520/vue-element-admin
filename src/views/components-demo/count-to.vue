<template>
  <div class="components-container">
    <aside>
      <a href="https://github.com/PanJiaChen/vue-countTo" target="_blank">如何使用countTo-component组件</a>
    </aside>
    ...
    <div style="margin-left: 25%;margin-top: 40px;">
      ...
      <label class="label" for="durationInput">动画持续时间:
        <input v-model.number="setDuration" type="number" name="durationInput">
      </label>
      <!--点击动画开始-->
      <div class="startBtn example-btn" @click="start">开始</div>
      <!--点击动画暂停及结束-->
      <div class="pause-resume-btn example-btn" @click="pauseResume">暂停</div>
      <br>
      <label class="label" for="decimalsInput">小数:
        <input v-model.number="setDecimals" type="number" name="decimalsInput">
      </label>
      <label class="label" for="separatorInput">分割符:
